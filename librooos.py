...
def ProductoNuevo():
    ...
    if ExisteCodigo(codigo)=="No existe":
        ...
        unidad=input('Ingrese la palabra "unidad": ')
        tipo=input('Ingrese genero: ')
        familia=input('Ingrese autor: ')
...
def IngresarProductoBDD(codigo):
    ...
    BuscarBDD(codigo)
    ingresos=input('Cantidad a ingresar: ')
    with open('Inventario.csv')as File:
        reader=csv.DictReader(File)
        for row in reader:
            #Compara el codigo hasta encontrar lugar vacio
...
def SalidaDeProducto():
    codigo=input('Ingrese codigo para darle salida: ')
    if ExisteCodigo(codigo)=="No existe":
        print('----Error el codigo que desea eliminar no existe----')
    else:
...
def SalidaProductoBDD(codigo):
    ...
    print('Datos del libro') 
    BuscarBDD(codigo)
    egresos=input('Cantidad de salida: ')
    with open('Inventario.csv')as File:
        reader=csv.DictReader(File)
        for row in reader:
            #Compara el codigo hasta encontrar lugar vacio
